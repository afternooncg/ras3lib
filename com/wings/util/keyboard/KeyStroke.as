package com.wings.util.keyboard
{
	 ...
	 * @author magic
	 */
	public class KeyStroke implements IKeyStroke
	{
		 ...
		 */
		public function KeyStroke(chars:String, code:uint){
			_chars = chars;
			_code = code;
		}
		...
		public static const VK_NUMPAD_ENTER:KeyStroke = new KeyStroke("Numpad_Enter", 108); // Enter
		...
		public static const VK_BACKSPACE:KeyStroke = new KeyStroke("Backspace", 8);//backspace
		public static const VK_TAB:KeyStroke = new KeyStroke("Tab", 9);//tab
		public static const VK_ENTER:KeyStroke = new KeyStroke("Enter", 13);//main ENTER
		public static const VK_SHIFT:KeyStroke = new KeyStroke("Shift", 16);//shift
		public static const VK_CONTROL:KeyStroke = new KeyStroke("Ctrl", 17);//ctrl
		public static const VK_ESCAPE:KeyStroke = new KeyStroke("Esc", 27);//esc
		public static const VK_SPACE:KeyStroke = new KeyStroke("Space", 32);//space
		
		public static const VK_CAPS_LOCK:KeyStroke = new KeyStroke("Cap", 20);//caps lock
		public static const VK_NUM_LOCK:KeyStroke = new KeyStroke("Num", 144);//num lock
		public static const VK_SCROLL_LOCK:KeyStroke = new KeyStroke("Scroll", 145);//scroll lock
		
		public static const VK_PAUSE:KeyStroke = new KeyStroke("Pause", 19);//pause / break
		public static const VK_PAGE_UP:KeyStroke = new KeyStroke("PageUp", 33);//page up
		public static const VK_PAGE_DOWN:KeyStroke = new KeyStroke("PageDown", 34);//page down
		public static const VK_END:KeyStroke = new KeyStroke("End", 35);//end
		public static const VK_HOME:KeyStroke = new KeyStroke("Home", 36);//home
		public static const VK_INSERT:KeyStroke = new KeyStroke("Insert", 45);//insert
		public static const VK_DELETE:KeyStroke = new KeyStroke("Delete", 46);//delete
		
		public static const VK_LEFT:KeyStroke = new KeyStroke("Left", 37);//left arrow
		public static const VK_UP:KeyStroke = new KeyStroke("Up", 38);//up arrow
		public static const VK_RIGHT:KeyStroke = new KeyStroke("Right", 39);//right arrow
		public static const VK_DOWN:KeyStroke = new KeyStroke("Down", 40);//down arrow
		
		public static const VK_WINDOWS:KeyStroke = new KeyStroke("Win", 91);//windows
		public static const VK_MENU:KeyStroke = new KeyStroke("Menu", 93);//menu
